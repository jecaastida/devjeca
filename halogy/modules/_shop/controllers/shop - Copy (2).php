...
class Shop extends MX_Controller {
	...
	function cart($quantity = '', $id = '')
	{
        ...
        if ($shippingBand == 2){
             if ($user['state'] == 'MM'){
                ...
                $shippingModifier = 2.33333;
            }
            if ($user['state'] == 'LUZ'){
                
                $shippingModifier = 3.33333;
            }
            if ($user['state'] == 'VIS'){
                
                $shippingModifier = 3.333333;
            }
        ...
        $this->form_validation->set_rules('shippingBand', 'Select Your Courier', 'required');
		// load content
                //print_r($data);
                //exit();
	...
	function login($redirect = '')
	{
		...
		$redirect = $redirect ? $redirect : $this->core->encode('/shop/checkout');
