...
$(function(){
	...
	if ($('input#variation3-1').val()){
        ...
        if ($('input#variation4-1').val()){
		$('div#variation4').children('div.showvars').show();
	}	
	...
	preview($('textarea#body'));	
        ...
        $(".uploadfile input.chk-del").click(function(){
           var parent = $(this).parent().parent().parent();
           if($(this).is(":checked")){
               $(this).attr('value',$("input.hid-img", parent).attr('value'))
               $("input.hid-img", parent).attr('value','')
           }else{
               $("input.hid-img", parent).attr('value',$(this).attr('value'));
           }
        });
...
<div id="images" class="tab" style="display: none;">
	...
	<?php echo anchor('/admin/shop/editImages/'.$productID, 'Add more Images', 'class="button toggle-image blue"' );?>
