...
<div id="tpl-shop" class="module">
	...
	<div class="col col1">
		...
		<form action="{page:uri}" method="post" class="default">
			...
			<input type="radio" name="payment_method" value="1"> BDO<br>
			<input type="radio" name="payment_method" value="2"> Cebuana Lhuiller/ LBC /Palawan<br>
			<input type="radio" name="payment_method" value="3"> Smart Padala<br>
