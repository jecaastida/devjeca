	...
	<?php echo $this->pagination->create_links(); ?>
		...
		<table class="images clear">	
			...
			?>
					...
					<a href="<?php echo $imagePath; ?>" title="<?php echo $image['img_caption']; ?>" class="lightbox"><?php echo ($thumb = display_image($imageThumbPath, $image['img_caption'], 100, 'class="pic"')) ? $thumb : display_image($imagePath, $image['img_caption'], 100, 'class="pic"'); ?></a>

					<p><strong><?php echo $image['img_caption']; ?></strong></p>
