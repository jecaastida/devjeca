...
<form action="<?php echo site_url($this->uri->uri_string()); ?>" method="post" class="default">
	...
	<div class="message">
		<p>
			<strong>Order ID #:</strong> <?php echo $order['transactionCode']; ?><br /> 
                        <strong>Reference ID #:</strong> <?php echo $order['reference_id']; ?><br />
			...
			<?php endif; ?>
			<?php if ($order['transaxTransID']): ?>
				<strong>Transax Transaction ID:</strong> <?php echo $order['transaxTransID']; ?>
			<?php endif; ?>
		</p>
	</div>
	...
	<div id="tpl-3col">
		...
		<div class="col1">	
			...
			<h2 class="underline">Products Ordered - Customer Type: <b><?php echo $order['groupName'] ?></b></h2>
